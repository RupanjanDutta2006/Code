  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-40 p-3.5 sm:p-4 rounded-2xl sm:rounded-3xl bg-light-blue hover:bg-light-blueHover dark:bg-gradient-to-r dark:from-neon-blue dark:via-brand-600 dark:to-neon-purple text-white shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2.5 sm:gap-3 group border border-white/30 backdrop-blur-xl touch-target"
      ...
      {isOpen && (
        <div className="fixed inset-0 sm:inset-y-0 sm:right-0 sm:left-auto z-50 w-full sm:w-[500px] lg:w-[540px] h-full h-screen-dvh bg-light-bg dark:bg-[#080a14]/98 backdrop-blur-2xl sm:border-l border-light-border dark:border-purple-500/20 shadow-2xl flex flex-col animate-slide-left transition-colors duration-200 safe-top">
          
          {/* Header */}
          <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-light-border dark:border-[#1b223c] flex items-center justify-between bg-white dark:bg-dark-950/90 shrink-0">
            <div className="flex items-center gap-2.5 sm:gap-3">
              <div className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-light-blue via-indigo-600 to-purple-600 dark:from-neon-blue dark:via-brand-600 dark:to-neon-purple text-white flex items-center justify-center shadow-md shadow-brand-500/25 shrink-0">
              ...
              <div>
                <h3 className="font-extrabold text-light-textStrong dark:text-white text-sm sm:text-base flex items-center gap-1.5 font-sans tracking-tight">
                  CodeVault AI <span className="text-[9px] sm:text-[10px] px-1.5 sm:px-2 py-0.5 rounded-full bg-light-blueSoft text-light-blue dark:bg-purple-500/20 dark:text-purple-300 border border-light-blueBorder/40 dark:border-purple-500/30">PRO</span>
                </h3>
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-5 bg-light-bg dark:bg-transparent">
                  ...
                  <div
                    className={`max-w-[92%] sm:max-w-[85%] rounded-2xl sm:rounded-3xl p-3.5 sm:p-4 shadow-xs ${
                      msg.role === 'user'
                        ...
                        : 'bg-white border border-light-border text-light-textStrong rounded-bl-none shadow-xs dark:bg-[#0e1222]/90 dark:border-[#232b4b] dark:text-dark-100 dark:shadow-lg'
                    }`}
                  >
            ...
            {isGenerating && (
              <div className="flex items-center gap-2 text-xs text-light-blue dark:text-indigo-400 animate-pulse pl-2 font-medium">
                <span className="w-2 h-2 rounded-full bg-light-blue dark:bg-neon-purple animate-ping" />
          ...
          <div 
            className="p-3 sm:p-4 bg-white dark:bg-dark-950/95 border-t border-light-border dark:border-[#1e2746] shrink-0"
          ...
          >
            <form onSubmit={handleSend} className="relative">
              <textarea
                ...
                className="w-full p-3 pr-20 rounded-xl sm:rounded-2xl bg-light-secondary dark:bg-dark-900 border border-light-borderStrong dark:border-[#232b4b] text-light-textStrong dark:text-white placeholder-light-textMuted dark:placeholder-dark-500 text-sm sm:text-xs font-mono outline-none focus:border-light-blue dark:focus:border-purple-500 focus:bg-white dark:focus:bg-dark-900 transition-all resize-none shadow-inner"
              />
              ...
              <div className="absolute right-2 bottom-2.5 flex items-center gap-1">
                {isGenerating ? (
                  ...
                  <button
                    type="submit"
                    disabled={!input.trim()}
                    className="w-9 h-9 rounded-xl bg-light-blue hover:bg-light-blueHover dark:bg-gradient-to-r dark:from-neon-blue dark:to-neon-purple text-white shadow-sm transition-all disabled:opacity-40 flex items-center justify-center active:scale-95 touch-target"
                    title="Send Message"
            ...
            <div className="flex items-center justify-between text-[10px] sm:text-[11px] text-light-textMuted dark:text-dark-400 mt-1.5 px-1">
              ...
              <span className="hidden sm:inline font-mono">Press <kbd className="px-1 py-0.5 bg-light-secondary dark:bg-dark-850 border border-light-border dark:border-dark-750 rounded text-light-textNormal dark:text-dark-300">Enter</kbd> to send</span>
            </div>
          </div>
        </div>
      )}
